...
class EnvService {
    ...
    async selectEnv(envsList, confirm) {
    ...
    async selectStartEnv(env, confirm = false) {
        ...
        if (shouldSelect && env) {
            ...
            this.app.menu.setSelectedModel(constants_1.ModelType.Completion, complModel);
            ...
            this.app.menu.setSelectedModel(constants_1.ModelType.Chat, chatModel);
            ...
            this.app.menu.setSelectedModel(constants_1.ModelType.Embeddings, embedModel);
            ...
            this.app.menu.setSelectedModel(constants_1.ModelType.Tools, toolsModel);
    ...
    async stopEnv() {
        await this.app.llamaServer.killFimCmd();
        this.app.menu.setSelectedModel(constants_1.ModelType.Completion, { name: "", localStartCommand: "" });
        await this.app.llamaServer.killChatCmd();
        this.app.menu.setSelectedModel(constants_1.ModelType.Chat, { name: "", localStartCommand: "" });
        await this.app.llamaServer.killEmbeddingsCmd();
        this.app.menu.setSelectedModel(constants_1.ModelType.Embeddings, { name: "", localStartCommand: "" });
        await this.app.llamaServer.killToolsCmd();
        this.app.menu.setSelectedModel(constants_1.ModelType.Tools, { name: "", localStartCommand: "" });
